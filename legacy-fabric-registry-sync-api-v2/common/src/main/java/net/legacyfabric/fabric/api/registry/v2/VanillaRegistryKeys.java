...
public class VanillaRegistryKeys {
	...
	public static final ResourceKey<Registry<Class<? extends BlockEntity>>> BLOCK_ENTITY_TYPE = net.ornithemc.osl.registries.api.registry.RegistryKeys.from("block_entity_type");
