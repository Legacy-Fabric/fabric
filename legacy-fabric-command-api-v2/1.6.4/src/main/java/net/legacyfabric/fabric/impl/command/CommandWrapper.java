...
public class CommandWrapper extends AbstractCommand {
	...
	public String getUsageTranslationKey(CommandSource source) {
		return this.mapping.getCallable().getHelp((PermissibleCommandSource) source).map(ChatMessage::toJson).orElse("");
	}
		...
		try {
			try {
				...
				if (e.shouldIncludeUsage()) {
					...
					source.method_5505(CommandMessageFormatting.error(ChatMessage.createTextMessage(String.format("Usage: /%s %s", this.getCommandName(), usage))));
				}
			}
		} catch (Throwable t) {
