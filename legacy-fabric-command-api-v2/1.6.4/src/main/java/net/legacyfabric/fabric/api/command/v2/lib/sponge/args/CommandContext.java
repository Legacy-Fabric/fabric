...
import net.legacyfabric.fabric.mixin.command.ChatMessageAccessor;
...
public final class CommandContext {
	...
	public static String textToArgKey(@Nullable ChatMessage key) {
		...
		if (((ChatMessageAccessor) key).getTranslationKey() != null) { // Use translation key
			return ((ChatMessageAccessor) key).getTranslationKey();
		}
