...
@Mixin({
		SoundManager.class, GameRenderer.class, LanguageManager.class, GrassColorReloader.class, FoliageColorReloader.class, TextureManager.class, TextRenderer.class
})
