...
package net.legacyfabric.fabric.api.client.screen.v1;
...
public final class ScreenEvents {
	 ...
	 */
	public static final Event<BeforeInit> BEFORE_INIT = EventFactory.createArrayBacked(BeforeInit.class, callbacks ->
	 ...
	 * }</pre>
	 *
	 * <p>Note that by adding an element to a screen, the element is not automatically {@link org.lwjgl.opengl.Drawable drawn}.
	 * Unless the element is button, you need to call the specific methods in the corresponding screen events.
	 *
	 * <p>This event can also indicate that the previous screen has been closed.
	 * @see ScreenEvents#BEFORE_INIT
	 */
	public static final Event<AfterInit> AFTER_INIT = EventFactory.createArrayBacked(AfterInit.class, callbacks ->
			(client, screen, scaledWidth, scaledHeight) -> {
	 ...
	 *
	 * <p>This event is typically used to undo any screen specific state changes such as setting the keyboard to receive
	 * {@link org.lwjgl.input.Keyboard#enableRepeatEvents(boolean)} (boolean) repeat events} or terminate threads
	 * spawned by a screen.
	 * This event may precede initialization events {@link ScreenEvents#BEFORE_INIT} but there is no guarantee that
	 * event will be called immediately afterwards.
	 */
