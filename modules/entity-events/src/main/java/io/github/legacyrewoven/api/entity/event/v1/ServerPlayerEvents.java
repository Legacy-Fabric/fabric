...
package io.github.legacyrewoven.api.entity.event.v1;
...
public final class ServerPlayerEvents {
	 ...
	 */
	public static final Event<CopyFrom> COPY_FROM = EventFactory.createArrayBacked(ServerPlayerEvents.CopyFrom.class, callbacks -> (oldPlayer, newPlayer, alive) -> {
