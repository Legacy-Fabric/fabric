...
public interface BrewingRecipesAccessor {
	...
	static void registerBottleItem(BrewingRecipes.Ingredient potion) {
		throw new UnsupportedOperationException();
	}

	@Invoker("registerBottleRecipe")
	static void registerBottleRecipe(PotionItem basePotion, BrewingRecipes.Ingredient ingredient, PotionItem resultingPotion) {
		throw new UnsupportedOperationException();
	}
