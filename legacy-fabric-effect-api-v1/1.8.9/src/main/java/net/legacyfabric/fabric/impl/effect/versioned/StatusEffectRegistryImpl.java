...
public class StatusEffectRegistryImpl {
	...
	public static final Registry<StatusEffect> REGISTRY = Registries.registerSimple(StatusEffectRegistryImpl.KEY, () -> {
	});
	...
	public static void init() {
		...
		SyncedRegistries.registerFixer(StatusEffectRegistryImpl.KEY, NamespacedIdentifiers.from("status_effect/id"), new StatusEffectIdFixer());
	}
