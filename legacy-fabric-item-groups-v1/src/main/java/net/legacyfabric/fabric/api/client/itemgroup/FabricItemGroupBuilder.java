...
public final class FabricItemGroupBuilder {
	 ...
	 * This bypasses {@link Item#appendToItemGroup}. If you want to append stacks from your items, consider using {@linkplain #appendItems(BiConsumer) the other overload}.
	 *
	 ...
	 * This allows you to call {@link Item#appendToItemGroup} yourself if you want.
	 *
