...
public class FabricCreativeGuiComponents {
	...
	static {
		...
		COMMON_GROUPS.add(ItemGroup.field_15657);
	}
	...
	public static class ItemGroupButtonWidget extends ButtonWidget {
		...
		public void renderBg(MinecraftClient client, int mouseX, int mouseY) {
			...
			if (this.visible) {
				...
				if (this.hovered) {
					gui.renderTooltip(I18n.translate("fabric.gui.creativeTabPage", extensions.fabric_currentPage() + 1, ((ItemGroup.itemGroups.length - 12) / 9) + 2), mouseX, mouseY);
				}
			}
		}
	}
