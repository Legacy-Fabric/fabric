...
public final class RegistrationHelperImpl implements LivingEntityFeatureRendererRegistrationCallback.RegistrationHelper {
	private final Function<EntityRenderLayer<?>, Boolean> delegate;

	public RegistrationHelperImpl(Function<EntityRenderLayer<?>, Boolean> delegate) {
		this.delegate = delegate;
	}

	@Override
	public <T extends LivingEntity> void register(EntityRenderLayer<T> featureRenderer) {
